...
function startGame2() {
    ...
    GameOver = new component(700, 500, "harshgameover.png", 0, 0,"image");
...
for (i in myObstacles) {
  if (myGamePiece.crashWith(myObstacles[i])) {
            ...
            var lif= document.getElementById("number").innerHTML;
            lif--;
            myObstacles.pop();
            document.getElementById("number").innerHTML=lif;
  }
...
if(myScore==50){
  nextLevel= document.getElementById("level").innerHTML;
  nextLevel++;
  document.getElementById("level").innerHTML= nextLevel;
